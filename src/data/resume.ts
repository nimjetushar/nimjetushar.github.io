...
export const resume: IResumeEntity = {
  ...
  skills: {
    ...
    overview: [
      ...
      {
        title: 'TypeScript',
        path: 'public/logo/typescript.svg',
        url: 'https://www.typescriptlang.org/',
        style: { width: '40px' },
      },
      {
        title: 'ES6',
        path: 'public/logo/es6.svg',
      ...
      {
        title: 'Express JS',
        path: 'public/logo/expressjs.svg',
      ...
      {
        title: 'RXJS',
        path: 'public/logo/rx-js.png',
        url: 'https://rxjs.dev/',
        style: { width: '40px' },
      },
      {
        title: 'Highchart',
        path: 'public/logo/highchart.png',
        url: 'https://www.highcharts.com/',
        style: { width: '40px' },
      },
      {
        title: 'jQuery',
        path: 'public/logo/jquery.png',
        url: 'https://jquery.com/',
        style: { width: '40px' },
      },
      {
        title: 'Material UI',
        path: 'public/logo/material-ui.png',
        url: 'https://mui.com/',
        style: { width: '40px' },
      },
      {
        title: 'Moment JS',
        path: 'public/logo/moment-js.png',
        url: 'https://momentjs.com/',
        style: { width: '40px' },
      },
      {
        title: 'Day JS',
        path: 'public/logo/day-js.png',
      ...
      {
        title: 'Nx dev',
        path: 'public/logo/nx-dev.svg',
        url: 'https://nx.dev/',
        style: { width: '50px', paddingBottom: '4px' },
      },
      {
        title: 'Webpack',
        path: 'public/logo/webpack.png',
      ...
      {
        title: 'Babel',
        path: 'public/logo/babel.png',
        url: 'https://babeljs.io/',
        style: { width: '40px' },
      },
      {
        title: 'eslint',
        path: 'public/logo/eslint.png',
        url: 'https://eslint.org/',
        style: { width: '40px' },
      },
      {
        title: 'Prettier',
        path: 'public/logo/prettier.png',
        url: 'https://prettier.io/',
        style: { width: '40px' },
      },
      {
        title: 'Jest',
        path: 'public/logo/jest.png',
        url: 'https://jestjs.io/',
        style: { width: '45px' },
      },
      {
        title: 'Karma',
        path: 'public/logo/karma.png',
        style: { width: '45px' },
      },
      {
        title: 'Jasmine',
        path: 'public/logo/jasmine.png',
        style: { width: '40px' },
      },
      {
        title: 'GIT',
      ...
      {
        title: 'Cordova',
        path: 'public/logo/cordova.webp',
        url: 'https://cordova.apache.org/',
        style: { width: '40px' },
      },
      {
        title: 'Ionic',
        path: 'public/logo/ionic.png',
        url: 'https://ionicframework.com/',
        style: { width: '40px' },
      },
      {
        title: 'SQL',
        path: 'public/logo/sql.png',
        style: { width: '40px' },
      },
      {
        title: 'Mongo DB',
        path: 'public/logo/mongodb.png',
        url: 'https://www.mongodb.com/',
        style: { width: '40px' },
      },
      {
        title: 'Nodepad ++',
        path: 'public/logo/notepad++.png',
        style: { width: '40px' },
      },
      {
        title: 'Visual Studio Code',
        path: 'public/logo/vs-code.webp',
        style: { width: '40px' },
      },
      {
        title: 'edge',
